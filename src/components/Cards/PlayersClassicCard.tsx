...
const PlayersClassicCard = () => {
    ...
    return (
        <Card className="max-w-sm">
            ...
            <Button type="button" onClick={() => setOpenPlayersClassicModal(true)} className="bg-medium-grey shadow-lg shadow-medium-grey-500/50 hover:bg-pale-grey">
...
export default PlayersClassicCard;