...
const CPUClassicCard = () => {
    ...
    return (
        <Card className="max-w-sm">
            ...
            <Button type="button" onClick={() => setOpenCPUClassicModal(true)} className="bg-medium-grey shadow-lg shadow-medium-grey-500/50 hover:bg-pale-grey">
                Saisir un pseudo
